    ...
    <div class="container">
        ...
        <div style="background:linear-gradient(135deg,var(--navy),#1a4a6e);border-radius:12px;padding:48px;color:var(--white);text-align:center;margin-bottom:60px">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:24px">
                @php $rwandaStats = [['#1','MICE Destination in Africa','ICCA Ranking'],['30 min','Airport to KCC','Transfer Time'],['100%','Renewable Power','National Grid'],['Safe & Clean','Business Climate','Consistently ranked']]; @endphp
                @foreach($rwandaStats as $stat)
                <div>
